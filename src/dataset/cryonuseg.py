...
class CryoNuSegDataset(_Dataset):
    """
    Dataset class for the CryoNuSeg dataset. This dataset contains images of histopathological slides of human tissue
    ...
    def __getitem__(self, idx) -> Tuple[_torch.Tensor, _torch.Tensor]:
        ...
        image, target = _Image.open(image_path), _Image.open(target_path).convert("L")
...
# MEAN = [0.5408, 0.3955, 0.5662]
# STD = [0.2234, 0.2411, 0.1918]
