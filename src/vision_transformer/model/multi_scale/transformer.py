...
class _TransformerBlock(_abc.ABC, _nn.Module):
    """
    Transformer block module for the encoder stage in the HRViT-Swin-Segmentation vision_transformer.
...
class TransformerBlockDecoder(_TransformerBlock):
    """
    Transformer block module for the decoder stage in the HRViT-Swin-Segmentation vision_transformer.
    """
