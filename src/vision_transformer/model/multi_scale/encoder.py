...
class Encoder(_nn.Module):
    """
    Encoder module of the HRViT-Swin-Segmentation vision_transformer.
    """
    ...
    def from_config(cls, config: _config.EncoderConfig) -> 'Encoder':
        ...
        :param config: Configuration object containing all semantic segmentation vision_transformer hyperparameters.
        """
