...
class SemanticSegmentationVisionTransformer(_base.SemanticSegmentationVisionTransformerBase):
    ...
    def __init__(
        ...
        self.__patch_fusions_scale_1 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_2, self.__patch_embedding_scale_3,
                self.__patch_embedding_scale_4, self.__patch_embedding_scale_5,
            ],
        ...
        self.__patch_fusions_scale_2 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_3,
                self.__patch_embedding_scale_4, self.__patch_embedding_scale_5,
            ],
        ...
        self.__patch_fusions_scale_3 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_2,
                self.__patch_embedding_scale_4, self.__patch_embedding_scale_5,
            ],
        ...
        self.__patch_fusions_scale_4 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_2,
                self.__patch_embedding_scale_3, self.__patch_embedding_scale_5,
            ],
        ...
        self.__patch_fusions_scale_5 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_2,
                self.__patch_embedding_scale_3, self.__patch_embedding_scale_4,
            ],
            out_patch_embedding=self.__patch_embedding_scale_5,
        )
