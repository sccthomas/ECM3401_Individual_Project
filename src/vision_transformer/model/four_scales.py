...
class SemanticSegmentationVisionTransformer(_base.SemanticSegmentationVisionTransformerBase):
    ...
    def apply_encoder_stage(
        ...
        :return: The output tensors for the 4 scales encoded.
        """
        ...
        for (
                # Encoder Scales
                encoder_scale_1, encoder_scale_2, encoder_scale_3, encoder_scale_4,
                # Patch Fusion Scales
                patch_fusion_scale_1, patch_fusion_scale_2, patch_fusion_scale_3, patch_fusion_scale_4
        ) in zip(
            # Encoder Scales
            encoders_scale_1[1:], encoders_scale_2[1:], encoders_scale_3[1:], encoders_scale_4[1:],
            # Patch Fusion Scales
            patch_fusions_scale_1, patch_fusions_scale_2, patch_fusions_scale_3, patch_fusions_scale_4,
        ):
            # - Patch Fusion Layer
            x1 = patch_fusion_scale_1(target_tensor=x1, tensors=[x2, x3, x4])
            x2 = patch_fusion_scale_2(target_tensor=x2, tensors=[x1, x3, x4])
            x3 = patch_fusion_scale_3(target_tensor=x3, tensors=[x1, x2, x4])
            x4 = patch_fusion_scale_4(target_tensor=x4, tensors=[x1, x2, x3])
