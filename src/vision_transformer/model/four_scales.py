...
class SemanticSegmentationVisionTransformer(_base.SemanticSegmentationVisionTransformerBase):
    """
    Semantic Segmentation Vision Transformer for 4 scales.
    """
    ...
    def __init__(
        ...
        super(SemanticSegmentationVisionTransformer, self).__init__(
            ...
            patch_embedding_scales=[
                patch_embedding_scale_1, patch_embedding_scale_2, patch_embedding_scale_3, patch_embedding_scale_4
            ],
        ...
        self.__patch_fusions_scale_1 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_2, self.__patch_embedding_scale_3, self.__patch_embedding_scale_4
            ],
        ...
        self.__patch_fusions_scale_2 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_3, self.__patch_embedding_scale_4
            ],
        ...
        self.__patch_fusions_scale_3 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_2, self.__patch_embedding_scale_4
            ],
            out_patch_embedding=self.__patch_embedding_scale_3,
        )
        #   - Scale 4
        self.__patch_fusions_scale_4 = self._create_patch_fusion_layers_for_scale_X(
            in_patch_embeddings=[
                self.__patch_embedding_scale_1, self.__patch_embedding_scale_2, self.__patch_embedding_scale_3
            ],
            out_patch_embedding=self.__patch_embedding_scale_4,
        )
    ...
    def apply_patch_embedding_stage(self, x: _torch.Tensor) -> _t.Dict[str, _torch.Tensor]:
        ...
        :return: The patch embeddings for the 4 scales.
        """
    ...
    def apply_encoder_stage(
        ...
        :param patch_embeddings: The patch embeddings for the 4 scales.
        :param return_attention_weights: Whether to return the attention weights.
        :return: The output tensors for the 4 scales encoded and optional attention weights.
        """
        ...
        skip_layer = 0
        for layer, (encoder_scale_1, encoder_scale_2, encoder_scale_3, encoder_scale_4) in enumerate(
                zip(encoders_scale_1[1:], encoders_scale_2[1:], encoders_scale_3[1:], encoders_scale_4[1:]), start=1
        ):
            # - Patch Fusion Layer
        ...
        return {'x1': x1, 'x2': x2, 'x3': x3, 'x4': x4}, weights
