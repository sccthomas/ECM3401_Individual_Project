...
from src.vision_transformer.common.decoder import HeavyWeightDecoder, LightWeightDecoder


class TestHeavyWeightDecoder(unittest.TestCase):
    def test_forward(self) -> None:
        ...
        decoder = HeavyWeightDecoder.create(
...
class TestLightWeightDecoder(unittest.TestCase):
    def test_forward(self) -> None:
        patch_embeddings = {
            'x1': torch.randn(1, 16, 1024),
            'x2': torch.randn(1, 64, 768),
