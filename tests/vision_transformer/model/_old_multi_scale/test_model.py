...
from src.vision_transformer.model._old_multi_scale.config import ModelConfig
from src.vision_transformer.model._old_multi_scale.model import SemanticSegmentationVisionTransformer
